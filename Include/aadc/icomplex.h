...
public:
   ...
   complex<T>& operator = (const complex<T>& other) {
    ...
    template<class X>
    complex& operator+=(const std::complex<X>& other) { re+=other.re; im+=other.im; return *this; }
    template<class X>
    complex& operator-=(const std::complex<X>& other) { re-=other.re; im-=other.im; return *this; }
    template<class X>
    complex& operator*=(const std::complex<X>& other) { 
        X re_=re*other.re - im*other.im; 
    ...
    template<class X>
    complex& operator/=(const std::complex<X>& other) { 
        idouble norm=other.re*other.re + other.im*other.im;
        X re_=(re*other.re + im*other.im)/norm; 
        im=(-re*other.im + im*other.re)/norm;
        re=re_;
        return *this; 
    }
...
inline complex<idouble> sinh( const complex<idouble>& z ) { return std::complex<idouble>(); }
inline complex<idouble> cosh( const complex<idouble>& z ) { return std::complex<idouble>(); }
