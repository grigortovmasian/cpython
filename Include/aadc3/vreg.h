...
namespace aadc {
    ...
    class VReg {
        ...
        static std::unordered_map<std::type_index, std::vector<std::pair<int, void*> > > obj_vtables;
        // number of vtables for the top object
        static int num_vtables;
